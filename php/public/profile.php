							...
							else if($action == 'view-warns' || $action == 'warn' || $action == 'unwarn')
							{
								...
								if($row)
								{
									...
									do
									{
										...
										if($can_unwarn_this_warn == 0){ $result .= " colspan=\"2\""; }
										$result .= ">";
										$result .= $description;
										$result .= "</td>";
							...
							else if($action == 'view-bans' || $action == 'ban' || $action == 'unban')
							{
														...
														<tr>
															...
															<td>
																<select name=\"is_permanent\">
																	<option value=\"1\" "; if($_POST['is_permanent'] === "1") echo "selected"; echo ">
																		Да
																	</option>
																	<option value=\"0\" "; if($_POST['is_permanent'] === null || $_POST['is_permanent'] === "0") echo "selected"; echo ">
																		Нет
																	</option>
																</select>
															</td>
								...
								if($row)
								{
									...
									do
									{
										...
										$result .= "</td>";
										$result .= "<td class=\"profile_extra_info_row_description\"";
										if($can_unban_this_ban == 0){ $result .= " colspan=\"2\""; }
										$result .= ">";
										$result .= $description;
										$result .= "</td>";
									...
									while($row = $result_set->fetch_assoc())
									{
										...
										echo "
													<tr>
														...
														<td>
															<input type=\"checkbox\" name=\"$name\" id=\"$name\""; if($is_attached){ echo " checked"; } if($is_disabled){ echo " disabled"; } echo ">
														</td>
													</tr>
										";
									}

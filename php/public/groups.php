					...
					<?php							
						...
						if($action == 'create' || $action == 'edit' || $action == 'delete' || $action == 'edit-permissions')
						{
								...
								echo "
										<table class=\"settings\">
											...
											<tr>
												...
												<td>
													<input required type=\"text\" size=\"4\" maxlength=\"4\" name=\"group-rank\" id=\"group-rank\" value=\"".$_POST['group-rank']."\" "; if($group_id == 1 || $group_id == 2 || $group_id == 3){ echo " disabled"; } echo ">
												</td>
											</tr>
										</table>
								";
							...
							echo "
										...
										<a href=\"/groups\"><input type=\"button\" value=\""; if($action == 'edit-permissions'){ echo "Закрыть"; } else { echo "Отмена"; } echo "\" name=\"button_cancel\"></a>
									</fieldset>
								</form>
							";
						}

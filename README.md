...
5. Проверить работу системы в браузере по адресу `http://localhost:80/` (порт настраивается в `.env`, `80` - значение по умолчанию);

...
if ($action == 'view') {
    ...
    if ($action == 'delete') {
        ...
        echo ">
															...
															<option value=\"0\" ";
        if (($_POST['forum_is_description_hided'] ?? null) === "0") echo "selected";
        echo ">
																Нет
															</option>
														</select>
        ...
        echo ">
															<option value=\"1\" ";
        if (($_POST['forum_is_category'] ?? null) === "1") echo "selected";
        echo ">
																Да
															</option>
															<option value=\"0\" ";
        if (($_POST['forum_is_category'] ?? null) === null || ($_POST['forum_is_category'] ?? null) === "0") echo "selected";
        echo ">
																Нет
															</option>
														</select>
        ...
        echo ">
															...
															<option value=\"0\" ";
        if (($_POST['topic_is_description_hided'] ?? null) === "0") echo "selected";
        echo ">
																Нет
															</option>
														</select>
        ...
        echo ">
															...
															<option value=\"0\" ";
        if (($_POST['topic_is_closed'] ?? null) === null || ($_POST['topic_is_closed'] ?? null) === "0") echo "selected";
        echo ">
																Нет
															</option>
														</select>
